    ...
    if( $recent_posts_query->have_posts() ) :  while( $recent_posts_query->have_posts() ) : $recent_posts_query->the_post(); global $post; ?>
        ...
        <div class="nectar-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> <?php if($i == 0) echo 'active'; ?> post-ref-<?php echo $i; ?>">
          ...
          echo '<div class="recent-post-container container"><div class="inner-wrap">';
            ...
            ?>
            <a class="nectar-button large regular <?php echo $button_color .  $regular_btn_class; ?> has-icon" href="<?php echo get_permalink(); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo __('Lire', NECTAR_THEME_NAME); ?> </span><i class="icon-button-arrow"></i></a>
        ...
        <div class="nectar-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo $i; ?>">
          ...
          echo '<span class="strong">';
            ...
            <?php if(!empty($options['theme-skin']) && $options['theme-skin'] == 'material') { ?>
              <a class="nectar-button large regular  <?php echo $button_color .  $regular_btn_class; ?>" href="<?php echo get_permalink(); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo __('Lire',NECTAR_THEME_NAME); ?> </span></a>
            <?php } else { ?>
                <a class="nectar-button large regular  <?php echo $button_color .  $regular_btn_class; ?> has-icon" href="<?php echo get_permalink(); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo __('Lire',NECTAR_THEME_NAME); ?> </span><i class="icon-button-arrow"></i></a>
            <?php } ?>
